...
func TestBuildWithFilterAllowAndDeny(t *testing.T) {
	r := NewRegistry()
	r.Register(PluginRegistration{ID: "skill-audit", Factory: func() Scanner { return NewSkillAuditDetector() }})
	r.Register(PluginRegistration{ID: "secret", Factory: func() Scanner { return NewSecretDetector() }})
	r.Register(PluginRegistration{ID: "dangerous", Factory: func() Scanner { return NewDangerousCallDetector() }})
