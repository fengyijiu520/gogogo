...
type JSONReportPayloadInput struct {
	...
	BehaviorCombination     any
	RemediationVerification any
	ReviewTrace             any
	ReviewAgentStats        any
}
...
func BuildJSONReportPayload(in JSONReportPayloadInput) map[string]interface{} {
	return map[string]interface{}{
		...
		"behavior_combination":     in.BehaviorCombination,
		"remediation_verification": in.RemediationVerification,
		"review_trace":             in.ReviewTrace,
		"review_agent_stats":       in.ReviewAgentStats,
	}
}
